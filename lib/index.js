...
var SpriteMagic = function () {
    ...
    _createClass(SpriteMagic, [{
        ...
        value: function createSass() {
            ...
            // variables (compass/sprite_importer/content.erb)
        ...
        value: function spriteImageUrl() {
            var imageUrl = '' + path.dirname(path.normalize(path.join(this.options.http_generated_images_path, this.context.url))) + this.context.suffix + '.png';
