...
var SpriteMagic = function () {
    ...
    _createClass(SpriteMagic, [{
        ...
        value: function checkCache() {
            ...
            var checkCacheSass = function checkCacheSass() {
                return new Promise(function () {
                    for (var _len4 = arguments.length, cb = Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
                        cb[_key4] = arguments[_key4];
                    }

                    fs.access(_this3.spriteSassPath(), cbResolver(cb));
                });
            };

            var readCacheData = function readCacheData() {
                return new Promise(function () {
                    for (var _len5 = arguments.length, cb = Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
                        cb[_key5] = arguments[_key5];
                    }

                    fs.readJson(_this3.spriteCacheDataPath(), cbResolver(cb));
                });
            };

            var checkImageHash = function checkImageHash(data) {
                return new Promise(function (resolve, reject) {
                    fs.readFile(_this3.spriteImagePath(), function (err, image) {
                        if (!err) {
                            var hash = Crypto.SHA1(image).toString(Crypto.enc.HEX);
                            if (hash === data.hash) {
                                return resolve();
                            }
                        }
            ...
            return new Promise(function (resolve) {
                Promise.resolve().then(checkCacheSass).then(readCacheData).then(checkImageHash).then(function () {
        ...
        value: function outputSpriteImage() {
            ...
            return Promise.resolve().then(function () {
                ...
                return new Promise(function () {
                    for (var _len7 = arguments.length, cb = Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
                        cb[_key7] = arguments[_key7];
                    }
        ...
        value: function outputSassFile() {
            ...
            return new Promise(function () {
                for (var _len8 = arguments.length, cb = Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {
                    cb[_key8] = arguments[_key8];
                }
        ...
        key: 'createCacheData',
        value: function createCacheData() {
            var _this7 = this;

            var readSpriteImage = function readSpriteImage() {
                return new Promise(function () {
                    for (var _len9 = arguments.length, cb = Array(_len9), _key9 = 0; _key9 < _len9; _key9++) {
                        cb[_key9] = arguments[_key9];
                    }

                    fs.readFile(_this7.spriteImagePath(), cbResolver(cb));
                });
            };

            var createHash = function createHash(image) {
                return Crypto.SHA1(image).toString(Crypto.enc.HEX);
            };

            var writeCacheData = function writeCacheData(hash) {
                return new Promise(function () {
                    for (var _len10 = arguments.length, cb = Array(_len10), _key10 = 0; _key10 < _len10; _key10++) {
                        cb[_key10] = arguments[_key10];
                    }

                    fs.writeJson(_this7.spriteCacheDataPath(), { hash: hash }, cbResolver(cb));
                });
            };

            return Promise.resolve().then(readSpriteImage).then(createHash).then(writeCacheData);
        }
    }, {
        key: 'createResult',
