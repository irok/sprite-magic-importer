...
var SpriteMagic = function () {
    ...
    _createClass(SpriteMagic, [{
        ...
        value: function createHash() {
            ...
            }).concat(JSON.stringify(this.options.spritesmith)).concat(JSON.stringify(this.options.pngquant)).concat(require('../package.json').version) // eslint-disable-line global-require
            .join('\0');
